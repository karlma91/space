...
SPRITE_ID SPRITE_BTN2;
SPRITE_ID SPRITE_BTN3;
SPRITE_ID SPRITE_CIRCLE;
...
{
	sprite_packload("spacetex.atlas");
}
...
void game_sprites(void)
{
	...
	REGISTER_SPRITE( BTN2 );
	REGISTER_SPRITE( BTN3 );
	REGISTER_SPRITE( CIRCLE );
